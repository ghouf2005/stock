    ...
    $("#submitProductForm").on('submit', function(e) {
      ...
      $.ajax({
        ...
        success: function(response) {
          $("#add-product-messages").html('<div class="alert alert-success">Product added successfully</div>');
          $("#submitProductForm")[0].reset();
          $("#addProductModal").modal('hide');
        },
        error: function() {
          $("#add-product-messages").html('<div class="alert alert-danger">Error adding product</div>');
        }
      });
    });
  });
